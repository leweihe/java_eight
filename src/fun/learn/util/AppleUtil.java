package fun.learn.util;

import java.util.ArrayList;
import java.util.List;

import fun.learn.object.Apple;
import fun.learn.service.AppleService;
...
public class AppleUtil {
	...
	public List<Apple> filterRedAndHeavyApples() {
		return this.appleService.filterByAction(allApples, (Apple a) -> "RED".equals(a.getColor()) && a.getWeight() > WEIGHT_LINE);
	}
